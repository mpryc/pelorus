...
# TBD_1: CI needs to create failures on the fly to enable this
...
class AbstractFailureCollector(pelorus.AbstractPelorusExporter):
    ...
    def collect(self):
        ...
        if critical_issues:
            ...
            #     else:
            #         number_of_dropped += 1
            #         debug_msg = f"Failure too old to be collected: failure_{'resolution' if m.is_resolution else 'creation'}_timestamp{{ app={m.labels[0]}, issue_number={m.labels[1]} }} {m.time_stamp}"

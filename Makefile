...
$(PELORUS_VENV): exporters/pelorus_common/requirements.txt \
                 exporters/committime/requirements.txt \
	...
	. ${PELORUS_VENV}/bin/activate && \
	       pip install -U pip && \
	       pip install -r exporters/pelorus_common/requirements.txt \
                       -r exporters/committime/requirements.txt \
